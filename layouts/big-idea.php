		...
		<div id="tm-middle" class="tm-middle uk-grid" data-uk-grid-match data-uk-grid-margin>
			...
			<div class="<?php echo $columns['main']['class'] ?>">
				...
				<main id="tm-content" class="tm-content">
					...
					<div class="tm-content-container-full">		
						...
						<?php 	
							...
							$image = get_field( 'wk_image' );
						

						    ?>
						      <div class="banner-big-idea">

								<div class="banner-container">

									<div class="banner-row">
										<div class="container-width flex align-center">
											<span><h1 class="condensed bold flex-1" style="text-align: right; font-size: 50px;"><?php the_title(); ?></h1></span>
											<span id="linea-color" style="display: inline-block; width: 10px; height: 180px; background: #ff7300; margin: 0 42px; }"></span> 
											<span class="flex-15" style="font-size: 22px; line-height: 1.5;"><?php the_field( 'wk_content' );  ?></span>
										</div>
									</div>
									...
									<div class="banner-row banner-row-vertical" style="background: rgba(211, 211, 211, 0.32);">
									
										<div class="container-width">
											
											<h4 class="color condensed bold" style="text-align: center; font-size: 50px; line-height: initial;"><?php the_field( 'mrt_big_idea_subheader' ); ?></h4>

											<div class="banner-text-block-container flex" style="padding: 60px 0;">
												<?php if( have_rows( 'mrt_big_idea_text_blocks' ) ) : while( have_rows( 'mrt_big_idea_text_blocks' ) ) : the_row(); ?>

														<span class="banner-text-block flex align-center flex-1-auto" style="font-size: 20px; line-height: 1.5;"><?php the_sub_field( 'mrt_big_idea_text_block' ); ?></span>
