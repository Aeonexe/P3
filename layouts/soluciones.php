	...
	<div class="uk-container uk-container-center">
		...
		<div id="tm-middle" class="tm-middle uk-grid" data-uk-grid-match data-uk-grid-margin>
			...
			<div class="<?php echo $columns['main']['class'] ?>">
				...
				<main id="tm-content" class="tm-content tyy">
					...
					<style id="flickity-fix">
						.carousel-cell {width: 100%;}
						ol.flickity-page-dots {top: -45px; 	height: 14px; }
					</style>
					...
					<div class="main-carousel js-flickity">						
						...
						<div class="carousel-cell">
							...
							<section class="tab-content tab-content-top">						
										...
										<?php while( $wp_querys->have_posts() ) : $counter++; $wp_querys->the_post(); ?>
											...
											<li>
												<a href="#tab-<?php the_ID(); ?>" class="<?php echo $active_class; ?>">
													<h6 class="condensed" style="margin: 0;"><strong><?php the_title(); ?></strong></h6>
												</a>
											</li>
								...
								<section id="first-tab-group" class="wk-tabgroup wk-tabgroup-a">
									...
									<?php
										...
										if( $wp_query->have_posts() ) : $counter = 0; while( $wp_query->have_posts() ) : $counter++; $wp_query->the_post(); ?>
											...
											<div id="tab-<?php the_ID(); ?>">
												<?php if( is_user_logged_in() ) : ?><h6 class="condensed" style="margin: 0;"><strong><?php the_title(); ?></strong></h6><?php endif; ?>
												<?php the_content(); ?>								
											</div>
						...
						<div class="carousel-cell">
							...
							<section class="tab-content tab-content-top">						
								...
								<ul class="wk-tabs clearfix" data-tabgroup="second-tab-group">
									...
									<?php if( $wp_query->have_posts() ) : $counter = 0; ?>

										<?php while( $wp_query->have_posts() ) : $counter++; $wp_query->the_post(); ?>
								...
								<section id="second-tab-group" class="wk-tabgroup wk-tabgroup-b">
						...
						<div class="carousel-cell">
							...
							<section class="tab-content tab-content-top">						
								...
								<ul class="wk-tabs clearfix" data-tabgroup="third-tab-group">
								...
								<section id="third-tab-group" class="wk-tabgroup wk-tabgroup-c">
