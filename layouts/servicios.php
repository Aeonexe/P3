		...
		<div id="tm-middle" class="tm-middle uk-grid" data-uk-grid-match data-uk-grid-margin>
			...
			<div class="<?php echo $columns['main']['class'] ?>">
				...
				<main id="tm-content" class="tm-content">
					...
					<div id="servicios-content" class="tm-content-container uk-grid blog-grid wk-flex-item wk-flex-wrap wk-m-flex-column">

						<?php if( have_posts() ) : while( have_posts() ) : the_post(); ?>

							<header>
								
								<h3 class="condensed remate" style="display: inline-block;"><?php the_title(); ?></h3>
						...
						$wp_query = new WP_Query( 'post_type=post&posts_per_page=-1&category_name=servicio' );

						if( $wp_query->have_posts() ) : while( $wp_query->have_posts() ) : $wp_query->the_post(); ?>


							<div id="servicio-<?php the_ID(); ?>" class="mrt-servicio" data-permalink="<?php the_permalink(); ?>" style="width: 100%;">

							    <div class="mrt-col-left">
							    	
							    	<img class="mrt-icon" src="<?php the_field( 'mrt_servicio_icon' ); ?>">
							    	
							    </div>

							    <div class="mrt-col-right">
									...
									<div class="mrt-blog-button-container ">
							    	
							    		<a class="mrt-blog-button" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php _e('Leer más', 'warp'); ?></a>
										
									</div>

							   		
							   		<?php edit_post_link(__('Editar este servicio', 'warp'), '<p><i class="uk-icon-pencil"></i> ','</p>'); ?>
